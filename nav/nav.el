...
(defcustom nav-follow-delay 1.05
...
(modify-face 'nav-face-dir "LightSkyBlue" nil nil nil nil nil nil)
...
;;          (rename-buffer (concat win "*"))
	  (select-window (nav-get-window nav-buffer-name))
	  (nav-push-dir dir)
          ;;	  (select-window (nav-get-window (concat win "*")))
